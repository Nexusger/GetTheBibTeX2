 ...
 *
 * Editors        Faruk Ates, Paul Irish, Alex Sexton
...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // Notes, Android < 4 will pass this test, but can only animate
    ...
    // Notes: in some older browsers, "no" was a return value instead of empty string.
    ...
    // Notes that the property names must be provided in the camelCase variant.
